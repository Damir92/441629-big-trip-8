...
export default class PointEdit extends Component {
    ...
    for (const pair of formData.entries()) {
      ...
      if (pointEditMapper[property]) {
        if (property === `date-start`) {
          pointEditMapper[property](newDay + ` ` + value);
      ...
      <form action="" method="get">
        <header class="point__header">
          <label class="point__date">
            choose day
            <input class="point__input" type="text" placeholder="Date" name="day" required>
          </label>
  ...
  bind() {
    ...
    this._flatpickrDate = flatpickr(this._element.querySelector(`.point__date input`), {allowInput: true, altInput: true, altFormat: `M j`});
    this._flatpickrStart = flatpickr(this._element.querySelector(`.point__time [name="date-start"]`), {allowInput: true, noCalendar: true, enableTime: true, altInput: true, altFormat: `H:i`});
    this._flatpickrEnd = flatpickr(this._element.querySelector(`.point__time [name="date-end"]`), {allowInput: true, enableTime: true, altInput: true, altFormat: `H:i`});
  }
